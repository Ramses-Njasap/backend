...
class Logout:
    """
    This Logs Out The User From A Remote Device.
    Since It Isn't Safe To Share User Token
    Attributed To A Single Device To Other Remote Devices,
    We Have To Set The Logout History
    For That Remote Device. If Any New Activity Is
    Detected By That Same Device, We Check If The Last
    Previous Activity For That Device Was A Logout,
    If it Was, We Redirect The User To Login Manually Rather
    Than Automatically Logging The User In. Otherwise,
    We Automatically Log The User In On That Device.
    """
    ...
    def set_logout_history(self, device_id: int):
        try:
            ...
            response.errors(
                ...
                for_developer=("Logout Failed: Device Does Not Exist."
                               " It Might Have Been Deleted. Try To Reload Page."),
                code="NOT_FOUND",
                status_code=404
            )
        ...
        _is_logout_history_set = self._set_logout_history(
    ...
    def _set_logout_history(self, device_instance):
        ...
        if latest_login_history_instance:
            ...
            response.errors(
                field_error="Logout Failed",
                for_developer=("Logout Failed: No Login History"
                               " For This Device Was Found."),
                code="NOT_FOUND",
                status_code=404
            )
