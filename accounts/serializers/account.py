...
from accounts.models.account import (PhoneNumberVerificationOTP,
                                     AccountVerification, KYCVerificationCheck)
...
class KYCVerificationCheckSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ("user", "id_card_verified", "passport_verified",
                  "driver_license_verified", "real_estate_certifications")


class AccountVerificationSerializer(serializers.ModelSerializer):
    class Meta:
        model = AccountVerification
        fields = ("user", "email_verified", "phone_number_verified",
                  "kyc_verification_check", "score", "created_on",
                  "updated_on")
    ...
    def to_representation(self, instance):
        ...
        representation["kyc_verification_check"] = KYCVerificationCheckSerializer(
            instance.kyc_verification_check).data
