...
class SubscriptionPlanManager(models.Manager):
    ...
    def filter_active_plans(self, auto: bool = True,
    ...
    def filter_inactive_plans(self, auto: bool = True,
                              *args, **kwargs) -> models.QuerySet:
        if not auto:
    ...
    def get(self, auto: bool = True,
        ...
        try:
            ...
            for_developer = (f"Multiple {self.model.__name__}."
                             f" Instances Match The Given Query Parameters."
                             f" Try Using .filter*** And You'll Get These Instances:"
                             f" {str(filtered_data)}")
    ...
    def get_active_plan(self, auto: bool = True,
                        *args, **kwargs) -> models.Model:
