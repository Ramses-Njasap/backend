...
class ImageOptimizer:
    ...
    def batch_optimize_images(self, input_dir, output_dir):
        ...
        - output_dir: str, path to the directory where
          optimized images will be saved
        """
...
if __name__ == "__main__":
    ...
    input_directory = (
        "/home/ramses/Desktop/LaLougeBackend"
        "/LaLouge/properties/images/input"
    )
    output_directory = (
        "/home/ramses/Desktop/LaLougeBackend"
        "/LaLouge/properties/images/output"
    )
    optimizer.batch_optimize_images(
        input_directory, output_directory
    )
    optimizer.compare_images(
        (
            "/home/ramses/Desktop/LaLougeBackend/LaLouge"
            "/properties/images/input/badimage.jpeg"
        ),
        (
            "/home/ramses/Desktop/LaLougeBackend/LaLouge"
            "/properties/images/output/badimage.jpeg"
        )
    )
